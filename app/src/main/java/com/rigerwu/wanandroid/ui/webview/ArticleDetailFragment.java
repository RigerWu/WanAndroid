...
public class ArticleDetailFragment extends SupportFragment implements FragmentKeyDown {
    ...
    public static ArticleDetailFragment getInstance(Bundle bundle) {

        ArticleDetailFragment mAgentWebFragment = new ArticleDetailFragment();
        if (bundle != null) {
...
//        mAgentWeb.uploadFileResult(requestCode, resultCode, data);
    ...
    public boolean onBackPressedSupport() {
        return mAgentWeb.back() || super.onBackPressedSupport();
    }
    ...
    private void showPoPup(View view) {
        if (mPopupMenu == null) {
            mPopupMenu = new PopupMenu(_mActivity, view);
    ...
    private PopupMenu.OnMenuItemClickListener mOnMenuItemClickListener = new PopupMenu.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.copy:
                    if (mAgentWeb != null) {
                        toCopy(_mActivity, mAgentWeb.getWebCreator().getWebView().getUrl());
                    }
                    return true;
